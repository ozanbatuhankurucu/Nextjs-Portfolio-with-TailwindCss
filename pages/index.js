        ...
        <section className='min-h-screen'>
          ...
          <div className='text-center p-10'>
            ...
            <p className='text-md py-5 leading-8 text-gray-800 max-w-lg mx-auto md:text-xl dark:text-white'>
              I am a front-end engineer who loves to build things for the web. I
              am currently working at{' '}
              <a
                href='https://www.arena-ai.com/'
                target='_blank'
                rel='noreferrer'>
                arena-ai
              </a>{' '}
          ...
          <div className='relative mx-auto bg-gradient-to-b from-teal-500 rounded-full border-2 border-teal-500 w-80 h-80 mt-8 mb-10 overflow-hidden md:h-96 md:w-96'>
            <Image
              src={devedwave}
              alt='dev-ed-wave'
              layout='fill'
          ...
          <div className='text-5xl flex justify-center gap-16 py-3 mb-10 text-gray-600'>
